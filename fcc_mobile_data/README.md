...
This folder defines all source code for the 'fcc_mobile_data' pipeline:
...
* Take a look at the sample under "sample_users_fcc_mobile_data.py" to get familiar with the syntax.
