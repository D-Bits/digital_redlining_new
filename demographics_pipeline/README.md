...
This folder defines all source code for the 'demographics_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_demographics_pipeline.py" to get familiar with the syntax.
