...
This folder defines all source code for the 'fcc_fixed_pipelines' pipeline:
...
* Take a look at the sample under "sample_users_fcc_fixed_pipelines.py" to get familiar with the syntax.
