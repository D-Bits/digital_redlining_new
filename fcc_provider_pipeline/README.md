# fcc_provider_pipeline

This folder defines all source code for the 'fcc_provider_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_fcc_provider_pipeline.py" to get familiar with the syntax.
